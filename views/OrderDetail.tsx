...
import { ChevronLeft, Phone, MessageSquare, Clock, MapPin, ChefHat, Bike, CheckCircle, Package, Timer } from 'lucide-react';
                   ...
                   <div key={idx} className="flex justify-between">
                      <div className="flex gap-3">
                         ...
                         <div>
                            ...
                            {item.specSnapshot && <div className="text-[10px] text-gray-400 mt-0.5">{item.specSnapshot}</div>}
                         </div>
                      </div>
